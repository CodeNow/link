...
let isObject = require('101/is-object')

let bunyan = require('bunyan')

let stdErrSerialiser = bunyan.stdSerializers.err
...
function errorSerializer (err) {
  let serialized = stdErrSerialiser(err)
  let job = keypather.get(serialized, 'data.job')
  if (job) {
