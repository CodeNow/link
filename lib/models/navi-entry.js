...
var rabbitmq = require('rabbitmq').getSubscriber()
...
/**
 * Enqueue a cache invalidation task to be processed by Navi
 */
NaviEntrySchema.statics._enqueueCacheInvalidationTask = function () {
