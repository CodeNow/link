      ...
      function processDependencies (dependencies) {
        ...
        if (dependencies) {
          dependencies.forEach(function (dependency) {
            console.log(dependency.attrs)
            console.log(dependency.getElasticHostname)
            console.log(dependency)
            newDependencies[dependency.getElasticHostname()] = dependency.attrs.shortHash
          })
        }
...
NaviEntrySchema.statics.handleInstanceUpdate = function (instance, timestamp) {
  ...
  return NaviEntrySchema.statics._getDirectURlObj(instance, timestamp)
    .then(function (directUrlObj) {
      ...
      var find = {$or: [timestampCheck, existsCheck]}
      var update = {
        $set: {
