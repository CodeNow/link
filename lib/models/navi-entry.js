        ...
        if (dependencies) {
          dependencies.forEach(function (dependency) {
            ...
            if (dependency.isolated) {
              var index = dependency.hostname.indexOf('--')
              newDep.isolatedMastersShorthash = dependency.hostname.slice(0, index)
              newDep.elasticUrl = dependency.hostname.slice(index + 2)
            }
