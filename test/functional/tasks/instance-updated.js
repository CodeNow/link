...
var isolatedSlaveInstance = require('../../mocks/isolated-slave-instance')
...
describe('functional', function () {
  describe('tasks', function () {
    describe('instance-updated', function () {
      ...
      //
      //describe('when isolating a branch', function () {
      //  var nockScope
      //  beforeEach(function (done) {
      //    nockScope = nock.load('./test/functional/fixtures/isolated-slave-instance.json')
      //    done()
      //  })
      //
      //  afterEach(function (done) {
